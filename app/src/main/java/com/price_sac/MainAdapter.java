...
class MainAdapter extends BaseExpandableListAdapter {
    ...
    public MainAdapter(Context context, List<String> listGroup,
                       HashMap<String, List<String>> listItem) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView textView = view.findViewById(R.id.list_pai);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView textView = view.findViewById(R.id.list_filho);
